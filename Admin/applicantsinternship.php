...
$name = isset($_GET['Internshipname']) ? $_GET['Internshipname'] : '';
$resul = mysqli_query($dbconnect, "SELECT * FROM internshipapplication where Internshipname='$name'");
 ...
 if (isset($_POST['savestatus'])) {
   ...
   $updateit = "UPDATE internshipapplication SET Status  = '$status'  WHERE ApplicationId='$id'";
...
<html>
<head>
	<title>Internship Applicants - <?php echo $name; ?></title>
...
<body>
  ...
  $result = mysqli_query($dbconnect, "SELECT * FROM internshipapplication where Internshipname='$name'");
 ...
 ?>
      <tr>
         ...
         <td><a class="viewresume" href="Internshipresumes/<?php echo $applicant['Resume'] ?>" target="pdf-frame">View Resume</a></td>
         <td><a class="viewresume" href="Internshipcoverletters/<?php echo $applicant['Coverletter'] ?>" target="pdf-frame">View Resume</a></td>
         <td>
            <form method="post">
